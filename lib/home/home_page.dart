import 'package:crud_project/analytics/pie_chart.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _filterButton() {
    return GestureDetector(
      onTap: () {
        BlocProvider.of<DiscountBloc>(context).add(FilterByExpiration(true));
        setState(() {
          if (isFiltered) {
            BlocProvider.of<DiscountBloc>(context).add(FetchDiscountCodes());
          } else {
            BlocProvider.of<DiscountBloc>(context)
                .add(FilterByExpiration(true));
          }
